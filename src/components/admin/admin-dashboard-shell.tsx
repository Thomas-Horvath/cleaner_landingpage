...
import { fetchAdminBookings, fetchAdminSession, logoutAdmin } from "@/lib/admin-api";
import type { AdminBookingItem, AdminSessionData } from "@/types/site";
          ...
          <div className="flex flex-col gap-4 border-b border-border/60 pb-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-muted">
                Itt látszanak a beérkező igények és a jelenlegi foglalási állapotok. A következő körben ide kerül majd a státuszváltás és a részletes kezelés is.
              </p>
            </div>
